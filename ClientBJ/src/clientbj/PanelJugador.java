...
public class PanelJugador extends JPanel {
	...
	public void pintarCartasInicio(ArrayList<Card> manoJugador) {
		x=5;
	...
	public void pintarLaCarta (Card carta) {
	...
	private class Recuerdo{
		private Card cartaRecordar;
		private int xRecordar;

		public Recuerdo(Card cartaRecordar, int xRecordar) {
